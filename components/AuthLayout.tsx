...
const AuthLayout: React.FC<AuthLayoutProps> = ({ children }) => {
  return (
    <div className="min-h-screen flex">
      {/* Left Branding Panel */}
      <div 
        className="hidden md:flex md:w-1/2 lg:w-[60%] bg-cover bg-center relative items-center justify-center p-12 text-white"
      ...
      {/* Right Form Panel */}
      <div className="w-full md:w-1/2 lg:w-[40%] bg-white flex items-center justify-center p-6 sm:p-12">
